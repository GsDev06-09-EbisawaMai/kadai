...
google.setOnLoadCallback(function() {
    ...
    gmap = {
        mapOptions: {
            center: new google.maps.LatLng( 35.422406, 136.143991 ),
        ...
        initialize: function() {
            ...
            var self = this,
                mapDiv = document.getElementById( 'map_03' ),
                getSize = function() {
        ...
        list: [
            ...
            {
                name: '綿貫征四郎の家（高堂の実家）',
                txt:  '（推定）<br>京都市山科区安朱周辺の可能性が高い。琵琶湖疎水（山科疏水）の分水路が通っている。 <br>「山一つ越えたところにある湖」 <br>「家の北側は山になっている。山の裾には湖から引いた疎水が走っている。家の南は田圃だ。その田圃に疎水から用水路が引かれている。その水路の途中が、この家の池になっている」 <br> 「ここから南禅寺山麓までは近い」（高堂）',
