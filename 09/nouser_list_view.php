...
if($status==false){
  ...
  while( $result = $stmt->fetch(PDO::FETCH_ASSOC)){
    $view .= "<p>";
    $view .= '<a href="nouser_list_info.php?id='.$result["id"].'">';
...
<title>【ログイン認証不要】ブックマークアプリ 本の一覧表示</title>
...
<header>
  <nav class="navbar navbar-default">
    ...
    <div class="navbar-header"><a class="navbar-brand" href="nouser_list_info.php">データ一覧</a></div>
    <!-- ユーザー登録 -->
